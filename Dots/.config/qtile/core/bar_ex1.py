"""Ex1 Bar Configuration for Qtile - Shadow Theme"""
...
# Ex1 color theme (shadow palette)
ex1_colors = {
    'accent': '#7E9AAB',      # Blue
    'secondary': '#96B088',   # Green  
    'tertiary': '#CCAC7D',    # Yellow
    'quaternary': '#BC8F7D',  # Red/Brown
    'quinary': '#A68CAA',     # Purple
    'senary': '#839C98',      # Teal
}
...
def _left_decor(color_key: str, padding_x=None, padding_y=4, round=False):
    ...
    color_value = ex1_colors.get(color_key, color.get(color_key, ex1_colors['accent']))
    return [
        RectDecoration(
            colour=color_value,
            radius=radius,
...
def create_ex1_bar():
    """Create EX1 bar that matches the default bar structure exactly"""
    ...
    return bar.Bar(
        [
            ...
            widget.CurrentLayout(
                foreground=ex1_colors['secondary'],
                padding=8,
            ...
            separator_sm(),
            widget.PulseVolume(
                foreground=ex1_colors['tertiary'],
            ...
            widget.TextBox(
                text='⏻',
                background=ex1_colors['quaternary'],
                foreground='#000000',
                font='Font Awesome 6 Free Solid',
                fontsize=18,
                padding=16,
